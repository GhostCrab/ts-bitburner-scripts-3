import { NS } from "@ns";
import { formatTime, getSlaves, getSlaveThreads, getTotalThreads, GROW_THREAD_MULT, HACK_PERCENT, HACK_PERCENT_MAX, MAX_BATCHES_PER_CYCLE, MS_BETWEEN_OPERATIONS, waitForHGWScripts } from "util";
